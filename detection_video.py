...
#detection yapilacak olan video okunur
cap = cv.VideoCapture("Koyun.mp4")

while True:
    _,img = cap.read()
    height, width,_= img.shape
    # img, pre-processing
    normalizasyon = cv.dnn.blobFromImage(img,1/255,(416,416),(0,0,0),swapRB=True,crop=False)
    ...
    # Non-Maximum Suppression, ayni obje icin birden fazla kutu olması durumu
    ...
    for i in indexes.flatten():
        ...
        cv.putText(img,label+ " "+ confidence, (x,y+20),font,1,(255,255,255),1)
